    ...
    internal static List<Project> GetProjects()
    {
        return new List<Project>
        {
            ...
            new Project
            {
                ...
                ResourcesConclusion = "Angular Material can be tricky at first, but trust us, you’ll learn to love it and once you master it, you will never look back. But as always, reach out in our <a  target='_blank' href='https://discord.gg/3rPP7UVC'>Discord community</a> if you get stuck!",
                Tips = new List<string>
                {
