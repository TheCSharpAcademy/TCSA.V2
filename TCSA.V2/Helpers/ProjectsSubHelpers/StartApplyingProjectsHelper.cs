        ...
        return new List<Project>
        {
             new Project
            {
                ...
                Tips = new List<string>
                {
                    ...
                    "Before publishing your portfolio, make sure it's reviewed by someone in the industry. If you post your work on our <a target='_blank' href='https://discord.gg/JVnwYdM79C'>Discord community</a>, we'll be happy to help.",
